    ...
    <div className="container mx-auto px-4 py-8 md:py-12">
      ...
      <div className="flex justify-center mb-8">
        <div className="inline-flex bg-gray-100 rounded-full p-1">
          {[
            { key: 'members' as TabType, label: '共享成员', icon: Users },
            { key: 'share' as TabType, label: '共享码', icon: Share2 },
            { key: 'preview' as TabType, label: '数据预览', icon: Eye },
          ].map((tab) => (
            <button
              key={tab.key}
            ...
            <div className="card p-6 mb-6 border-2 border-primary-200">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <SelectAllPermissions
                      permissions={newMemberPermissions}
                      setter={setNewMemberPermissions}
                    />
                  </div>
                ...
                <div className="flex justify-end gap-3 pt-2">
                  <button
                    onClick={() => setShowAddMember(false)}
                    className="px-5 py-2 rounded-full text-gray-600 hover:bg-gray-100 font-medium transition-all"
                  >
                    取消
                  </button>
                  <button
                      ...
                      <div className="pt-4">
                        <div className="flex items-center justify-between mb-3">
                          ...
                          <SelectAllPermissions
                            ...
                            setter={(p) => updateMemberPermissions(member.id, p)}
                          />
                        </div>
            ...
            <div className="card p-6 bg-gradient-to-br from-primary-50 to-lavender-50 border-2 border-primary-200">
              <div className="text-center">
                ...
                <div className="inline-flex items-center gap-2 bg-white px-8 py-4 rounded-2xl shadow-lg mb-4">
                  <span className="font-mono text-3xl font-bold tracking-widest gradient-text">
                    {generatedCode}
                  </span>
                  <button
                ...
                <p className="text-xs text-gray-500">
                  {copiedCode ? '已复制到剪贴板！' : '点击右侧图标复制'}
                </p>
                <p className="text-xs text-gray-500 mt-2">
                  请在 {shareValidHours} 小时内使用，过期将自动失效
                </p>
              </div>
            </div>
          )}
          ...
          {activeShareCodes.length > 0 && (
            <div className="card p-6">
              <h3 className="font-bold text-gray-800 mb-4 flex items-center gap-2">
                ...
                待使用的共享码 ({activeShareCodes.length})
              </h3>
                  ...
                  >
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        过期时间：{new Date(code.expiresAt).toLocaleString('zh-CN')}
                      </p>
                    </div>
                    <button
                      onClick={() => revokeShareCode(code.id)}
                      className="text-rose-500 hover:text-rose-600 hover:bg-rose-50 p-2 rounded-lg transition-all"
                    >
                      <Trash2 className="w-4 h-4" />
                    </button>
                  </div>
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="card p-6 bg-gradient-to-br from-gray-50 to-white">
            ...
            {Object.values(previewPermissions).every((v) => !v) ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {previewPermissions.cycle && previewData.cycle && (
                  <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium text-gray-800">{previewData.cycle.cyclePhase}</span>
                      </div>
                      {previewData.cycle.daysUntilNextPeriod !== undefined && (
                        <div className="flex justify-between">
                          <span className="text-gray-500 text-sm">距下次经期</span>
                          <span className="font-medium text-gray-800">
                            {previewData.cycle.daysUntilNextPeriod} 天
                          </span>
                        </div>
                      )}
                      <div className="flex justify-between">
                        ...
                        <span
                          className={cn(
                            'font-medium',
                            previewData.cycle.hasPainToday ? 'text-rose-500' : 'text-emerald-500'
                          )}
                        >
                          {previewData.cycle.hasPainToday
                            ? previewPermissions.pain && previewData.cycle.painLevel
                              ? { none: '无', mild: '轻微', moderate: '中度', severe: '严重' }[previewData.cycle.painLevel]
                              : '有不适'
                            : '无不适'}
                        </span>
                      </div>
                ...
                {previewPermissions.sleep && previewData.sleep && (
                  <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100">
                    <div className="flex items-center gap-3 mb-3">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium text-gray-800">{previewData.sleep.avgDuration} 小时</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-500 text-sm">平均质量</span>
                        <span className="font-medium text-gray-800">{previewData.sleep.avgQuality} / 5</span>
                      </div>
                      <div className="flex justify-between">
                        ...
                        <span
                          className={cn(
                            'font-medium',
                            previewData.sleep.poorSleepDays > 2 ? 'text-rose-500' : 'text-gray-800'
                          )}
                        >
                          {previewData.sleep.poorSleepDays} 天
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                {previewPermissions.mood && previewData.mood && (
                  <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100">
                    <div className="flex items-center gap-3 mb-3">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium text-gray-800">{previewData.mood.recentMood}</span>
                      </div>
                      <div className="flex justify-between">
                        ...
                        <span
                          className={cn(
                            'font-medium',
                            previewData.mood.moodTrend === 'improving' && 'text-emerald-500',
                            previewData.mood.moodTrend === 'declining' && 'text-rose-500',
                            previewData.mood.moodTrend === 'stable' && 'text-gray-800',
                            previewData.mood.moodTrend === 'unknown' && 'text-gray-400'
                          )}
                        >
                          {
                            {
                ...
                {previewPermissions.medication && previewData.medication && (
                  <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100">
                    <div className="flex items-center gap-3 mb-3">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium text-gray-800">
                          {previewData.medication.todayTaken} / {previewData.medication.todayTotal}
                        </span>
                      </div>
                      <div>
                        <div className="flex justify-between mb-1">
                          ...
                          <span
                            className={cn(
                              'font-medium',
                              previewData.medication.adherenceRate >= 80
                                ? 'text-emerald-500'
                                : previewData.medication.adherenceRate >= 50
                                ? 'text-amber-500'
                                : 'text-rose-500'
                            )}
                          >
                            {previewData.medication.adherenceRate}%
                          </span>
                        </div>
                        <div className="w-full bg-gray-100 rounded-full h-2">
                          <div
                            ...
                            style={{ width: `${previewData.medication.adherenceRate}%` }}
                          />
                        </div>
                      </div>
                    </div>
